...
var Litepicker = function (t) {
            ...
            if ("string" == typeof e) {
                ...
                if (o.length) {
                    ...
                    for (var a = 0, l = Object.entries(o); a < l.length; a++) {
                        var c = l[a], h = c[0], p = c[1], d = Number(h), u = t.formatPatterns(p[0], n), m = u.group,
                            f = u.pattern;
    ...
    var r = i(5), a = i(0), l = i(3), c = i(2), h = function (t) {
        ...
        return o(e, t), e.prototype.scrollToDate = function (t) {
            ...
            var n = this.ui.getBoundingClientRect(), o = i.getBoundingClientRect(), s = t.getBoundingClientRect(),
                r = s.top, a = s.left;
    ...
    var r = i(7), a = i(0), l = i(1), c = function (t) {
        ...
        return o(e, t), e.add = function (t, e) {
            ...
            var e = t.getBoundingClientRect(), i = this.ui.getBoundingClientRect(),
                n = this.options.position.split(" "), o = window.scrollX || window.pageXOffset,
                s = window.scrollY || window.pageYOffset, r = 0, a = 0;
